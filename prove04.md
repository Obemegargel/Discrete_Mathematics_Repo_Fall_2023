...
**Answer**:  
* Is Well Defined because ... Every x input results in a y output.
* Not One-to-One because ... Entering a negative produces the same result as its positive. multiple inputs lead to the same output.
* Not Onto because ... No negative y values possible. Not every y value is accounted for.
...
|:-:|:-:|:-:|:-:|:-:|
|$f : \mathbf{R} \to \mathbf{R}$|$2x+3$|(y-3)/2|9|3|
|$f : \lbrace x \in \mathbf{R} : x \gt 0 \rbrace \to \mathbf{R}$|$3^x$|e^(x*ln(3))|27|27|
